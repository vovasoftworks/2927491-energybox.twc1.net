...
class Crm_Project_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit
{
	...
	public function setObject($object)
	{
		...
		$oMainTab
			...
			->move($this->getField('color')->set('data-control', 'hue')->divAttr(array('class' => 'form-group col-xs-12 col-sm-4 col-md-3')), $oMainRow3)
			->move($this->getField('datetime')->divAttr(array('class' => 'form-group col-xs-12 col-sm-6 col-lg-3')), $oMainRow3)
			->move($this->getField('deadline')->divAttr(array('class' => 'form-group col-xs-12 col-sm-6 col-lg-3')), $oMainRow3)
			->add($oScript);
